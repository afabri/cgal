...
#ifndef CGAL_PRIMARY_AABB_TRAITS_H_
#define CGAL_PRIMARY_AABB_TRAITS_H_
...
struct Primary_AABB_traits_base;

template <class Primitive>
struct Primary_AABB_traits_base<Primitive,false>{};

template <class Primitive>
struct Primary_AABB_traits_base<Primitive,true>{
...
// Primary_AABB_traits_base_2 brings in the Intersection_distance predicate,
...
struct Primary_AABB_traits_base_2;

template <typename GeomTraits>
struct Primary_AABB_traits_base_2<GeomTraits,false>{};

template <typename GeomTraits>
struct Primary_AABB_traits_base_2<GeomTraits,true>{
  ...
  // Defining Bounding_box and other types from the full Primary_AABB_traits
...
class Primary_AABB_traits:
  public internal::AABB_tree::Primary_AABB_traits_base<AABBPrimitive>,
  public internal::AABB_tree::Primary_AABB_traits_base_2<GeomTraits>
{
  typedef typename CGAL::Object Object;
public:
  typedef GeomTraits Geom_traits;

  typedef Primary_AABB_traits<GeomTraits, AABBPrimitive> AT;
  ...
  {
    const Primary_AABB_traits<GeomTraits,AABBPrimitive>& m_traits;
  public:
    Sort_primitives(const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
      : m_traits(traits) {}
  ...
  class Compute_bbox {
    const Primary_AABB_traits<GeomTraits,AABBPrimitive>& m_traits;
  public:
    Compute_bbox(const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
      :m_traits (traits) {}
  ...
  class Do_intersect {
    const Primary_AABB_traits<GeomTraits,AABBPrimitive>& m_traits;
  public:
    Do_intersect(const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
      :m_traits(traits) {}
  ...
  class Closest_point {
    ...
    const Primary_AABB_traits<GeomTraits,AABBPrimitive>& m_traits;
  public:
    Closest_point(const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
      : m_traits(traits) {}
...
private:
  ...
  static Bounding_box compute_bbox (const Primitive& pr,
                                    const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
  {
    return internal::Primitive_helper<AT>::get_datum(pr,traits);
  }
  ...
  static bool less_x(const Primitive& pr1, const Primitive& pr2,const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
  {
  ...
  static bool less_y(const Primitive& pr1, const Primitive& pr2,const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
  {
    return GeomTraits().less_y_3_object()( internal::Primitive_helper<AT>::get_reference_point(pr1,traits),
                                           internal::Primitive_helper<AT>::get_reference_point(pr2,traits) );
  }
  static bool less_z(const Primitive& pr1, const Primitive& pr2,const Primary_AABB_traits<GeomTraits,AABBPrimitive>& traits)
  {
    return GeomTraits().less_z_3_object()( internal::Primitive_helper<AT>::get_reference_point(pr1,traits),
                                           internal::Primitive_helper<AT>::get_reference_point(pr2,traits) );
  }

};  // end class Primary_AABB_traits
...
typename Primary_AABB_traits<GT,P>::Axis
Primary_AABB_traits<GT,P>::longest_axis(const Bounding_box& bbox)
{
...
#endif // CGAL_PRIMARY_AABB_TRAITS_H_
