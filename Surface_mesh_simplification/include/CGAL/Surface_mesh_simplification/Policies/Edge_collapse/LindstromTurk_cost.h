...
public:
  ...
  operator()(const Profile& aProfile, const optional<typename Profile::Point>& aPlacement) const
  {
    return LindstromTurkCore<TriangleMesh, Profile>(mParams, aProfile).compute_cost(aPlacement);
  }
